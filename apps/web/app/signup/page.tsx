...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[#FAFAF7]">
      {/* Left panel — branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#2D9B6F] to-[#1E7A56] relative items-center justify-center p-12">
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-2xl font-display font-bold">PetPulse</span>
            </div>
            <h1 className="text-4xl font-display font-bold mb-4 leading-tight">
              Notice what changes,<br />
              <span className="text-[#A8E6CF]">before it&apos;s a problem.</span>
            </h1>
            <p className="text-white/70 text-lg">
              AI-powered health tracking for your pets. Join thousands of pet parents who catch issues early.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="text-xl font-display font-bold text-[#1A1A1A]">PetPulse</span>
          </div>

          <h2 className="text-3xl font-display font-bold text-[#1A1A1A] mb-2">Create your account</h2>
          <p className="text-[#6B7280] mb-8">
            Already have an account?{' '}
            <Link href="/login" className="text-[#2D9B6F] font-semibold hover:underline">
              Sign in
            </Link>
          </p>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-[#E8E4DA] rounded-xl bg-white hover:border-[#2D9B6F] transition-colors font-semibold text-[#1A1A1A]"
          >

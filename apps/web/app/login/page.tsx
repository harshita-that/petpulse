    ...
    <div className="min-h-screen flex bg-[#FAFAF7]">
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          >
            ...
            <p className="text-white/70 text-lg">
              Check in on your pets and track their health progress over time.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <h2 className="text-3xl font-display font-bold text-[#1A1A1A] mb-2">Sign in</h2>
          <p className="text-[#6B7280] mb-8">
            Don&apos;t have an account?{' '}
            <Link href="/signup" className="text-[#2D9B6F] font-semibold hover:underline">
              Create one
            </Link>
          </p>
